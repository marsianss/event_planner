            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('events.store') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="short_description" name="short_description" type="text" class="mt-1 block w-full" :value="old('short_description')" />
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">
                                        {{ __('Maximum file size: 2MB. Recommended dimensions: 1200x600px.') }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6">
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="end_date" name="end_date" type="datetime-local" class="mt-1 block w-full" :value="old('end_date')" />
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <x-text-input id="latitude" name="latitude" type="text" class="mt-1 block w-full" :value="old('latitude')" placeholder="e.g. 51.5074" />
                                        <x-input-error :messages="$errors->get('latitude')" class="mt-2" />
                                    </div>

                                    <div>
                                        <x-input-label for="longitude" :value="__('Longitude (Optional)')" />
                                        <x-text-input id="longitude" name="longitude" type="text" class="mt-1 block w-full" :value="old('longitude')" placeholder="e.g. -0.1278" />
                                ...
                                <div class="flex space-x-4 mt-4">
                                    <div>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="is_private" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ old('is_private') ? 'checked' : '' }}>
                        ...
                        <div id="private-event-fields" class="border-t pt-6 mt-6 {{ old('is_private') ? '' : 'hidden' }}">
                            <div class="max-w-md">
                                <x-input-label for="access_code" :value="__('Access Code for Private Event')" />
                                <x-text-input id="access_code" name="access_code" type="text" class="mt-1 block w-full" :value="old('access_code')" />
                        ...
                        <div class="border-t pt-6 mt-6">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <textarea id="custom_fields" name="custom_fields" rows="3" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('custom_fields') }}</textarea>
                        ...
                        <div class="flex items-center justify-end gap-4 border-t pt-6">
                            ...
                            <button type="submit" name="publish" value="1" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                {{ __('Publish Event') }}
                            </button>
                        </div>
                    </form>
